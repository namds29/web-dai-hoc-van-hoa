...
const PARTNER_LIST = [
  ...
  },
  {
    ...
    description:
      "Hsuan Chuang University is a private Buddhist university located in Xiangshan District, Hsinchu City, Taiwan. Hsuan Chuang University was founded in 1997 by Mr. Liao Zhong and named after the Tang Dynasty monk Xuanzang.",
  ...
  },
  {
    ...
    description:
      "Mindoro University (MinSU) was formerly named Mindoro College of Agriculture and Technology (MinsCAT). The college is considered as high-quality school in the province. The University focuses on academic strategies, administration, research to meet the needs of a growing population.In June 2023, the TUCST had cooperation agreements with Southern Luzon University and Mindoro State University on academic exchange, lecturer exchange in the fields of  Music, Tourism, Sports, School Administration, and scientific research.",
  ...
  },
  {
    ...
    description:
      "SkillsSG Ventures (SSGV) is a private corporation of consulting and training from Singapore. Each company has 15-30 years of industry-specific expertise in skills development according to the standard of SkillsFuture Singapore's renowned Workforce Skills Qualification (“WSQ”). In addition to being a pioneering member of the Strategic Association of Professional Training and Consulting Organizations (SAPTCO Singapore), the companies also support national initiatives such as the WSQ framework, Transformation Map of industry, WorldSkills Singapore 2018 and the internationalization of Singapore's teaching program, assessment and certification. These companies have implemented many projects and consultations in Indonesia, the Philippines, Malaysia, Vietnam, Myanmar, Timor Leste, Seychelles, India and China.",
    ...
    <section className="w-full">
      ...
      <div className="flex min-h-[100vh] gap-10">
        ...
        <section className="text-black p-4 w-full">
          ...
          <div className="grid grid-cols-2 gap-10">
            {PARTNER_LIST.map((item) => (
              <Fragment key={item.title}>
                <div
                  key={item.title}
                  className="border bg-gray-200 p-4 text-center "
                >
          ...
          <div>
            <p>Phone: 036.456.9586 (Zalo, Viber, Whatapps)</p>
            <p className="mt-2">Email: htqt.tucst@gmail.com</p>
            <p className="mt-2">
              Department of Scientific Management - International Cooperation
            </p>
          </div>
        </section>
      </div>
