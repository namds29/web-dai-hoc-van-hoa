export const DATA_DETAIL = [
    {
        ...
        <p style="margin-bottom: 1rem; margin-top:1rem">On the 2024 Admission Consultation-Career Guidance Day, hundreds of admission consulting booths from training institutions such as Hanoi National University, Hanoi Polytechnic University, and National Economics University... were present. Among them, TUCST school's booth is carefully prepared with an outstanding space, combining cultural and artistic activities to attract students. TUCST's booth received great attention from a large number of students.</p>
        <img src="/img/school3.jpg" />
        <p style="margin-bottom: 1rem; margin-top:1rem">Here, TUCST's staff presented TUCST's training programs, the 2024 admission project, and the values and opportunities of becoming a TUCST student. In addition, TUCST staff will answer all questions for students and parents about admission information, admission methods, tests to assess students’ ability and thinking, and advice on choosing a training program.</p>
    ...
    },
    {
        ...
        <img src="/img/school7.jpg" />
        <p style="margin-bottom: 1rem; margin-top:1rem">In general, opinions focus on recommending that the Provincial People's Committee focus on 2 groups of proposals: First, on specific mechanisms and policies in developing science and technology activities to attract experts with achievements in scientific research; Associate professors in the fields of Culture - Arts, Sports and Tourism work at TUCST to both enhance the potential of Thanh Hoa province's intellectual team and help TUCST ensure its training capacity,  create new majors that the Province needs; It is recommended that the Province consider and decide for TUCST to be a sector-level unit to carry out the province's grassroots-level science and technology tasks. The second is a group of proposals for investing in facilities and improving science and technology potential, including Improving scientific research capacity for staff and students of TUCST through training and coaching at home and abroad; Supporting TUCST on mechanisms and policies to build strong research groups; Supporting information technology for digital transformation to improve the efficiency of management of science and technology activities at TUCST.</p>
        <img src="/img/school8.jpg" />
        <p style="margin-bottom: 1rem; margin-top:1rem">At the meeting, representatives of leaders of the Department of Science and Technology and the Department of Culture, Sports and Tourism also had many exchanges and clarified the proposals and recommendations of the University's lecturers and staff. Mr Tran Duy Binh - Department of Science and Technology expressed his agreement, accepted a number of suggestions and recommendations, and prioritized the implementation of specific research models, for example, restoring and creating national monuments locally; In addition, he also proposed that TUCST launch topic registration in a larger number as well as coordinate with relevant organs to develop new projects such as the Startup Project for students.
        <p style="margin-bottom: 1rem; margin-top:1rem">Ms. Vuong Thi Hai Yen - Deputy Director of the Department of Culture, Sports and Tourism proposed that TUCST implement a new project on digital transformation in the upcoming period. Besides, she also proposed that the University coordinate to research the bottleneck of the current industry, which is the Culture Industry – TUCST’s strength; building basic culture; and activities to preserve and restore festivals.</p>
        <p style="margin-bottom: 1rem; margin-top:1rem">At the ceremony, Mr. Le Duc Giang congratulated TUCST for the great achievements that TUCST has achieved through 57 years of construction and development, and emphasized: realizing the goal of building TUCST into a university with training scale, training majors, training level, and scientific research leading in the top local universities depends on many factors, including great effort and effort of the TUCST faculty and staff. He made additional comments on the summary report and directions and tasks in the new period of TUCST. Besides, he also highly appreciated TUCST's work program organization; the changing appearance of TUCST in the recent period; about some innovative ideas and proposals in science and technology work. Mr. Le Duc Giang also directly directed the TUCST’s Governing Board in scientific research on promoting the spirit of solidarity within TUCST; developing specific strategies for science and technology activities as well as building a comprehensive TUCST development project.
        </p>
        <div style="text-align:center;width:100%;font-weight:bold;margin-top:1rem">Other images in the event:</div>
        <img style="margin-top:1.4rem; border-radius:5px" src="/img/school9.jpg" />
    ...
    },
    {
        ...
        <p style="margin-bottom: 10px;">The opening ceremony took place with the theme "The color convergence of Dien Bien and Thanh Hoa" with colorful melodies, crystallized from epic songs such as Huyền thoại Điện Biên, Nổi trống đồng lên, Hò kéo pháo, trên đồi Him Lam, Giải phóng Điện Biên, Chào sông Mã anh hùng... connecting the past, present and future between the two provinces of Thanh Hoa and Dien Bien.</p>
        <p style="margin-bottom: 10px;">After the opening ribbon cutting, the audience enjoyed eye-catching performances with elaborate investments by hundreds of artists, singers from art troupes, and artisans from the two provinces. The opening program demonstrated the spirit as well as the unique cultural beauty of the two provinces with great development potential.</p>
        <p style="margin-bottom: 10px;">Thanh Hoa-Dien Bien Tourism and Culture Week will present and promote tourism and cooperation between the two provinces, creating opportunities for units and businesses to do business. Tourism businesses promote information exchange and market development. Thanh Hoa-Dien Bien Tourism and Culture Week in Thanh Hoa promises to bring new experiences and discoveries to a large number of people and tourists about the land and people of Dien Bien; presents the potential and orientations in tourism development, cultural heritages, typical tourism products, OCOP products, events, festivals, destinations, mechanisms, policies, and tourism projects that Dien Bien and Thanh Hoa are prioritizing to attract investment.</p>
    ...
    },
    {
        ...
        content: `<h1 style="font-weight:700;margin-bottom:1rem">TUCST Youth Month Activities 2024</h1>
            ...
            <p style="margin-bottom: 1rem">On the morning of March 17, TUCST Running 2024 was held at TUCST with the participation of Dr. Vu Van Tuyen - Deputy Secretary of the Party Committee, Chairman of TUCST Council; Dr. Dong Huong Lan – TUCST Vice President. TUCST Running 2024 takes place in the exciting competitive atmosphere of Youth Month. The final result is:</p>
            <h2 style="font-weight:700;margin-bottom:1rem">Men's singles</h2>
            <ul>
              <li>- The first prize: No.009 – Student Bui Duy Khanh (Faculty of Law & State Management)</li>
              <li>- The second prize: No.001 – Student Le Duc Thang (Faculty of Fine Arts)</li>
              <li>- The third prize:
                <ul>
                  <li>- No.011 – Student Nguyen Le Thanh (Faculty of Music)</li>
                  <li>- No.004 – Student Lo Xuan Thanh (Faculty of Music)</li>
                </ul>
              </li>
            </ul>
            <img style="margin-bottom:1rem; margin-top:1rem" src="/img/cam2.jpg" />
            <h2 style="font-weight:700;margin-bottom:1rem">Women's singles</h2>
            <ul>
              <li>- The first prize: No.062 – Student Luc Phuong Cam (Faculty of Tourism)</li>
              <li>- The second prize: No.090 – Student Bui Thu Luyen (Faculty of Music)</li>
              <li>- The third prize:
                <ul>
                  <li>- No.137 – Student Tour Manesone (Faculty of Law & State Management)</li>
                  <li>- No.048 Mai Thi Ut Nhi (Faculty of Preschool and Primary Education)</li>
                </ul>
              </li>
            </ul>
            <img style="margin-bottom:1rem; margin-top:1rem" src="/img/cam3.jpg" />
            <h2 style="font-weight:700;margin-bottom:1rem">Relay race</h2>
            <ul>
              <li>- The first prize: Team of Hotel Management K10 (Faculty of Tourism)</li>
              <li>- The second prize: Team of Music (Faculty of Music)</li>
              <li>- The third prize: Team of old people (Faculty of Law & State Management)</li>
            </ul>
            <img style="margin-bottom:1rem; margin-top:1rem" src="/img/cam4.jpg" />
